...
cue_snd_t = 1/sound_fs:1/sound_fs:0.2;
cue_freq = 5e2;
cue_sound = sin(2*pi*cue_freq*cue_snd_t).*gausswin(numel(cue_snd_t),3)';

err_freq1 = 3000;
err_freq2 = 5000;
err_t = 1/sound_fs:1/sound_fs:2;
error_sound = sin(2*pi*err_freq1*err_t) + sin(0.33*pi*err_freq2*err_t);
